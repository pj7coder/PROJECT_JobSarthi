...
class Aurora {
  constructor(element, options = {}) {
    ...
    this.colorStops = options.colorStops || ['#6784ff', '#b575f2', '#ff27f3'];
  ...
  init() {
    ...
    this.gl.canvas.className = 'aurora-container';
    ...
    this.program = new Program(this.gl, {
      ...
      uniforms: {
        ...
        uColorStops: { value: this.colorStopsArray },
        uResolution: { value: [this.element.offsetWidth, this.element.offsetHeight] },
  ...
  destroy() {
    ...
    if (this.element && this.gl.canvas.parentNode === this.element) {
